...
public class MakeFileWriter extends Unit {
    ...
    public void process() throws Exception {
        ...
        RenderingHintImp hint = new RenderingHintImp("FILE_WRITER_RENDERING_HINT", false);
    ...
    public void init() {
        ...
        setPopUpDescription("Makes a tool into a File Writer");
        setHelpFileLocation("MakeFileWriter.html");
