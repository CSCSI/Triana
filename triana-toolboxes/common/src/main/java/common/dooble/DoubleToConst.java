...
/**
 * Converts a double into a conzt
 *
 * @author Ian Wang
 * @version $Revision: 2921 $
 */
public class DoubleToConst extends Unit {
    ...
    */
    ...
    public void process() throws Exception {
        java.lang.Double input = (java.lang.Double) getInputAtNode(0);

        output(new Const(input.doubleValue()));
    }
    ...
    public void init() {
        ...
        setPopUpDescription("Converts a double into a conzt (real part only)");
        setHelpFileLocation("DoubleToConst.html");
    }
     ...
     */
    public void dispose() {
        // Insert code to clean-up DoubleToConst (e.g. close open files) 
    }
