...
/**
 * Converts two doubles into a complex conzt
 *
 * @author Ian Wang
 * @version $Revision: 2921 $
 */
public class DoubleToComplex extends Unit {
    ...
    */
    ...
    public void process() throws Exception {
        java.lang.Double real = (java.lang.Double) getInputAtNode(0);
        java.lang.Double imag = (java.lang.Double) getInputAtNode(1);

        output(new Const(real.doubleValue(), imag.doubleValue()));
    }
    ...
    public void init() {
        ...
        setPopUpDescription("Converts two doubles into a complex conzt");
        setHelpFileLocation("DoubleToComplex.html");
    }
     ...
     */
    public void dispose() {
        // Insert code to clean-up DoubleToComplex (e.g. close open files) 
    }
