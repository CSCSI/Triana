...
public class ConstViewPanel extends ParameterPanel implements TaskListener {
    ...
    public void init() {
        ...
        val = new JLabel("Value = 0", JLabel.CENTER);
    ...
    public void parameterUpdated(ParameterUpdateEvent event) {
        ...
        if (paramname.equals(CONST_VALUE) && (getTask().getParameter(CONST_VALUE) != null)) {
            ...
            val.setText("Value = " + (String) getTask().getParameter(CONST_VALUE));
        }
    }
