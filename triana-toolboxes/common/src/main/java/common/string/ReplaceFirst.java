 ...
 */
public class ReplaceFirst extends Unit {
    ...
    public void process() throws Exception {
        ...
        output(input.replaceFirst(regex, replaceWith));
    }
    ...
    public void init() {
        ...
        setPopUpDescription("Replace the first occurance of a regular expression within a string");
        setHelpFileLocation("ReplaceFirst.html");
