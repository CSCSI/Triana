...
public class LowPass extends Unit {
    ...
    public void process() throws Exception {
        ...
        if (lowpass == null) {
            lowpass = new LowPassEffect(delayOffset, feedback, filterType, chunked, delayInMs, sampleRate);
        }
    ...
    public void parameterUpdate(String paramname, Object value) {
        ...
        if (paramname.equals("delayInMs")) {
            ...
            if (lowpass != null) {
                lowpass.setDelayOffset(delayInMs);
            }
        }
        ...
        if (paramname.equals("filterType")) {
            ...
            if (lowpass != null) {
                lowpass.setFilterType(filterType);
            }
        }
