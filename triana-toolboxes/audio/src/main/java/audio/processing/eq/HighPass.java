...
public class HighPass extends Unit {
    ...
    public void process() throws Exception {
        ...
        if (highpass == null) {
            highpass = new HighPassEffect(delayOffset, feedback, filterType, chunked, delayInMs, sampleRate);
        }
    ...
    public void parameterUpdate(String paramname, Object value) {
        ...
        if (paramname.equals("delayInMs")) {
            ...
            if (highpass != null) {
                highpass.setDelayOffset(delayInMs);
            }
        }
        ...
        if (paramname.equals("filterType")) {
            ...
            if (highpass != null) {
                highpass.setFilterType(filterType);
            }
        }
