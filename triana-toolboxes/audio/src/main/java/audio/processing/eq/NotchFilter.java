...
public class NotchFilter extends Unit {
    ...
    public void process() throws Exception {
        ...
        if (notch == null) {
            notch = new NotchFilterEffect(delayOffset, frequency, chunked, delayInMs, sampleRate, Q, dbGain);
        }
    ...
    public void init() {
        ...
        setPopUpDescription("");
        setHelpFileLocation("NotchFilter.html");
        ...
        String guilines = "";
        guilines += "Center Frequency (%) $title frequency Scroller 0 16000 200 false\n";
        guilines += "Gain (dB) (%) $title dbGain Scroller 0.0 60.0 0.0 false\n";
        guilines += "Q Value $title Q Scroller 0 6 0.7 false\n";
