...
public class HighPassEffect extends AudioEffect16Bit {
    ...
    public HighPassEffect(int forwardMemSize, int feedback, String filterType, boolean chunked, float delayInMs,
                          float sampleRate) {
