...
public class BandPass extends Unit {
    ...
    public void process() throws Exception {
        ...
        if (bandpass == null) {
            bandpass = new BandPassEffect(delayOffset, frequency, chunked, delayInMs, sampleRate, Q, dbGain);
        }
    ...
    public void init() {
        ...
        setPopUpDescription("");
        setHelpFileLocation("BandPass.html");
        ...
        guilines += "Gain (dB) (%) $title dbGain Scroller 0.0 40.0 0.0 false\n";
