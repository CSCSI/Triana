...
/**
 * A Variable Dynamics Effect - Unfinished.... This effect is a unique effect Created by Eddie Al-Shakarchi
 *
...
public class VariableDynamics extends Unit {
    ...
    VariableDynamicsEffect dynamic = null;
    ...
    public void process() throws Exception {
        ...
        if (dynamic == null) {
            dynamic = new VariableDynamicsEffect(threshold, ratio, attack, release, gain, autoGain,
    ...
    public void init() {
        ...
        defineParameter("attack", "6.0", USER_ACCESSIBLE);
        defineParameter("release", "12.0", USER_ACCESSIBLE);
        ...
        guilines += "Attack Speed (ms) $title attack Scroller 0 100 6 false\n";
        guilines += "Release Speed (ms) $title release Scroller 0 100 12 false\n";
    ...
    public void parameterUpdate(String paramname, Object value) {
        ...
        if (paramname.equals("threshold")) {
            ...
            if (dynamic != null) {
                dynamic.setThreshold(threshold);
            }
        }
        ...
        if (paramname.equals("release")) {
            ...
            if (dynamic != null) {
                dynamic.setReleaseTime(release);
            }
        }
        ...
        if (paramname.equals("detectionType")) {
            ...
            if (dynamic != null) {
                dynamic.setDetectionType(detectionType);
            }
        }
        ...
        if (paramname.equals("thresholdWidth")) {
            ...
            if (dynamic != null) {
                dynamic.setThresholdWidth(thresholdWidth);
            }
        }
