 ...
 */
public class HalfSampleRate extends OldUnit {
    ...
    /**
     * @return a string containing the names of the types allowed to be input to HalfSampleRate, each separated by a
     *         white space.
     */
    ...
    /**
     * @return a string containing the names of the types output from HalfSampleRate, each separated by a white space.
     */
