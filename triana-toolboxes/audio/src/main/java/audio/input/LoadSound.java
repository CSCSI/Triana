...
public class LoadSound extends OldUnit {
    ...
    public void process() throws Exception {
        ...
        while (chunkNo < numberOfChunks) {
            ...
            if (bytes == null) {
                ...
                System.out.println("BUFSIZE IS WHAT?! = " + bufSize);
            }
            ...
            do {
                try {
                    ...
                    System.out.println("BYTESREAD IS WHAT?! = " + bytesread);
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            if (format.getSampleSizeInBits() > 16) { // i.e. for 24 and 32, store as ints
                ...
                for (chan = 0; chan < channels; ++chan) {
                    ...
                    int test = bytes.length / 2 / channels;
    ...
    public String getPopUpDescription() {
        return "LoadSound loads a soundfile (e.g. WAV, AU) and streams the output";
    }
