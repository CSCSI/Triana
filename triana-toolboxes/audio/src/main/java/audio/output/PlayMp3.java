...
public class PlayMp3 extends Unit {
...
//                    bigendian);
            ...
            for (int chan = 0; chan < newformat.getChannels(); ++chan) {
                ...
                System.out.println("AUDIO FORMAT =" + au);
...
// For each channel... basically this converts from multiple audio to byte array
        for (chan = 0; chan < channels; ++chan) {
            ...
            int test = newformat.getSampleSizeInBits();
            ...
            } else if (newformat.getSampleSizeInBits() == 32) {

                System.out.println("I shouldn't be able to read this");
