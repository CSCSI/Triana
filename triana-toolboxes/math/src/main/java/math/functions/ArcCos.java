 ...
 */
public class ArcCos extends Unit {
                ...
                if (((GraphType) input).isArithmeticArray(dv)) {
                    ...
                    if (((GraphType) input).isDependentComplex(dv)) {
                        ...
                        if ((FlatArray.maxArray(inputdataR) <= 1.0) &&
                            ...
                            System.out.println("Warning: Some input real data to " + getTask().getToolName() + " are out of range (abs(data) "
                                    + "< 1). Output will be complex.");
