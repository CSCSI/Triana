 ...
 * ANY THEORY OF LIABILITY, ARI
 SING OUT OF OR IN CONNECTION WITH THE USE
 ...
 */
public class Multiplier extends Unit {
    ...
    public void init() {
        ...
        setHelpFileLocation("Mulipler.html");
    ...
    /**
     * The main functionality of Multiplier goes here
     */
    public void process() {
        Object nextInput;
        ...
        for (int i = 1; i < getInputNodeCount(); ++i) {
            ...
            if (result instanceof Arithmetic) {
                if (((Arithmetic) result).isCompatible(nextInput)) {
                    result = ((Arithmetic) result).multiply(nextInput);
                } else {
