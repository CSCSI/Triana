 ...
 */
public class Lnb extends OldUnit {
    /**
     * The UnitWindow for Lnb
     */

    PixelMap sourceMap, destMap;

    /**
     * ********************************************* ** USER CODE of Lnb goes here    ***
     * *********************************************
     */
    public void process() {
    ...
    /**
     * Saves Lnb's parameters to the parameter file.
     */
    public void saveParameters() {
    }

    /**
     * Loads Lnb's parameters of from the parameter file.
     */
    public void setParameter(String name, String value) {
    }

    /**
     * @return a string containing the names of the types allowed to be input to Lnb, each separated by a white space.
     */
    ...
    /**
     * @return a string containing the names of the types output from Lnb, each separated by a white space.
     */
    ...
    public String getPopUpDescription() {
        return "Sets the value of a pixel to the value of the largest 8 way connected pixel";
    }
