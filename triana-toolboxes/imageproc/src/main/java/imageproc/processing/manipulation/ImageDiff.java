 ...
 */
public class ImageDiff extends OldUnit {
    ...
    public void process() {
        ...
        if ((pixelMap1.width != pixelMap2.width) ||
            ...
            new ErrorDialog(
                    getName() + ": Error, incompatible iimage dimensions." + "\n" +
    ...
    /**
     * @return a string containing the names of the types output from ImageDiff, each separated by a white space.
     */
