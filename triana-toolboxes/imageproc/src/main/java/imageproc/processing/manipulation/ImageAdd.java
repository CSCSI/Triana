...
public class ImageAdd extends Unit {
    ...
    /**
     * Saves ImageAdd's parameters to the parameter file.
     */
    public void saveParameters() {
    }

    /**
     * Loads ImageAdd's parameters of from the parameter file.
     */
    ...
    public String getPopUpDescription() {
        return "Mathematical adds the values of the pixels in two PixelMaps.";
    }
