...
public class PositiveF extends Unit {
    ...
    public static void keepPositiveFrequencies(GraphType input) {
...
//    }
    ...
    /**
     * Used to set each of PositiveF's parameters. This should NOT be used to update this unit's user interface
     */
...
//
    ...
    public String getPopUpDescription() {
        return "Zero all negative-frequency amplitudes of a spectral set";
    }
