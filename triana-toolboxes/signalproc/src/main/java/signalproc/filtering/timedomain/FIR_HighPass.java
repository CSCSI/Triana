...
/**
 * An FIR_HighPass unit to apply an FIR low-pass filter smoothed by a windowing function chosen by the user. The order
...
public class FIR_HighPass extends OldUnit {
    ...
    private void setCoefficients() {
        int j;
        double omega = (1.0 - freqToNyquist) * pi;
    ...
    /*
    * Initialses information specific to FIR_HighPass.
    */
