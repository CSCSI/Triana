...
public abstract class JmDNS implements Closeable {
    ...
    public static JmDNS create() throws IOException {
        return new org.trianacode.pegasus.jmdns.impl.JmDNSImpl(null, null);
    }
    ...
    public static JmDNS create(final String name) throws IOException {
        return new org.trianacode.pegasus.jmdns.impl.JmDNSImpl(null, name);
    }
     ...
     * {@link NetworkTopologyDiscovery.Factory#setClassDelegate(NetworkTopologyDiscovery.Factory.ClassDelegate)}. This must be done before creating a {@link org.trianacode.pegasus.jmdns.JmDNS} or {@link JmmDNS} instance.
     * </p>
     *
     * @param addr
     *            IP address to bind to.
     ...
     * @return null if the service information cannot be obtained
     */
    public abstract org.trianacode.pegasus.jmdns.ServiceInfo getServiceInfo(String type, String name, boolean persistent);
     ...
     */
    public abstract void addServiceListener(String type, org.trianacode.pegasus.jmdns.ServiceListener listener);
     ...
     *            listener for service updates
     */
    public abstract void removeServiceListener(String type, org.trianacode.pegasus.jmdns.ServiceListener listener);
