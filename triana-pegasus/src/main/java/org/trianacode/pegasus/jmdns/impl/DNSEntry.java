...
public abstract class DNSEntry {
    ...
    private final org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType _recordType;
     ...
     * Create an entry.
     */
    DNSEntry(String name, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType type, DNSRecordClass recordClass, boolean unique) {
        _name = name;
    ...
    public boolean isSameEntry(DNSEntry entry) {
        return this.getKey().equals(entry.getKey()) && this.getRecordType().equals(entry.getRecordType()) && ((org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.CLASS_ANY == entry.getRecordClass()) || this.getRecordClass().equals(entry.getRecordClass()));
    }
     ...
     * @return record type
     */
    public org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType getRecordType() {
        return (_recordType != null ? _recordType : org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.TYPE_IGNORE);
    }
    ...
    public DNSRecordClass getRecordClass() {
        return (_dnsClass != null ? _dnsClass : org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.CLASS_UNKNOWN);
    }
