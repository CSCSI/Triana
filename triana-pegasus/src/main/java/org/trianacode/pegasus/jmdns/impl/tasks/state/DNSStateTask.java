...
import org.trianacode.pegasus.jmdns.impl.DNSStatefulObject;
...
/**
 * This is the root class for all state tasks. These tasks work with objects that implements the {@link org.trianacode.pegasus.jmdns.impl.DNSStatefulObject} interface and therefore participate in the state machine.
 *
...
public abstract class DNSStateTask extends DNSTask {
    ...
    private static int _defaultTTL = org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.DNS_TTL;

    /**
     * The state of the task.
     */
    private org.trianacode.pegasus.jmdns.impl.constants.DNSState _taskState  = null;
     ...
     * @param ttl
     */
    public DNSStateTask(org.trianacode.pegasus.jmdns.impl.JmDNSImpl jmDNSImpl, int ttl) {
        super(jmDNSImpl);
        _ttl = ttl;
    }
    ...
    protected void associate(DNSState state) {
        ...
        for (org.trianacode.pegasus.jmdns.ServiceInfo serviceInfo : this.getDns().getServices().values()) {
    ...
    protected void removeAssociation() {
        ...
        for (org.trianacode.pegasus.jmdns.ServiceInfo serviceInfo : this.getDns().getServices().values()) {
            ((org.trianacode.pegasus.jmdns.impl.ServiceInfoImpl) serviceInfo).removeAssociationWithTask(this);
        }
    }
    ...
    protected abstract org.trianacode.pegasus.jmdns.impl.DNSOutgoing buildOutgoingForDNS(org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException;

    protected abstract org.trianacode.pegasus.jmdns.impl.DNSOutgoing buildOutgoingForInfo(org.trianacode.pegasus.jmdns.impl.ServiceInfoImpl info, org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException;

    protected abstract org.trianacode.pegasus.jmdns.impl.DNSOutgoing createOugoing();
     ...
     */
    protected org.trianacode.pegasus.jmdns.impl.constants.DNSState getTaskState() {
     ...
     */
    protected void setTaskState(org.trianacode.pegasus.jmdns.impl.constants.DNSState taskState) {
