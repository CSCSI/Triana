...
public final class DNSOutgoing extends DNSMessage {
    ...
    public static class MessageOutputStream extends ByteArrayOutputStream {
        ...
        void writeRecord(DNSRecord rec, long now) {
            ...
            writeShort(rec.getRecordClass().indexValue() | ((rec.isUnique() && _out.isMulticast()) ? org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.CLASS_UNIQUE : 0));
    ...
    public DNSOutgoing(int flags, boolean multicast, int senderUDPPayload) {
        ...
        _maxUDPPayload = (senderUDPPayload > 0 ? senderUDPPayload : org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.MAX_MSG_TYPICAL);
     ...
     * @throws IOException
     */
    public void addAnswer(org.trianacode.pegasus.jmdns.impl.DNSIncoming in, DNSRecord rec) throws IOException {
     ...
     * @throws IOException
     */
    public void addAdditionalAnswer(org.trianacode.pegasus.jmdns.impl.DNSIncoming in, DNSRecord rec) throws IOException {
        MessageOutputStream record = new MessageOutputStream(512, this);
        record.writeRecord(rec, 0);
        byte[] byteArray = record.toByteArray();
        if (byteArray.length < this.availableSpace()) {
    ...
    public boolean isQuery() {
        return (this.getFlags() & org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.FLAGS_QR_MASK) == org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.FLAGS_QR_QUERY;
    }
