...
public final class DNSIncoming extends DNSMessage {
    ...
    public static class MessageInputStream extends ByteArrayInputStream {
        ...
        public String readName() {
            ...
            while (!finished) {
                ...
                switch (org.trianacode.pegasus.jmdns.impl.constants.DNSLabel.labelForByte(len)) {
                    case Standard:
                        int offset = pos - 1;
                        ...
                        break;
                    case Compressed:
                        int index = (org.trianacode.pegasus.jmdns.impl.constants.DNSLabel.labelValue(len) << 8) | this.read();
    ...
    public DNSIncoming(DatagramPacket packet) throws IOException {
        super(0, 0, packet.getPort() == org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.MDNS_PORT);
        this._packet = packet;
...
//        System.out.println("Source : " + source.toString());
    ...
    private DNSQuestion readQuestion() {
        ...
        org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType type = org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.typeForIndex(_messageInputStream.readUnsignedShort());
        if (type == org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.TYPE_IGNORE) {
        ...
        org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass recordClass = org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.classForIndex(recordClassIndex);
    ...
    private DNSRecord readAnswer(InetAddress source) {
        ...
        int recordClassIndex = _messageInputStream.readUnsignedShort();
        org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass recordClass = (type == org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.TYPE_OPT ? org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.CLASS_UNKNOWN : org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.classForIndex(recordClassIndex));
        if ((recordClass == org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass.CLASS_UNKNOWN) && (type != org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.TYPE_OPT)) {
        ...
        switch (type) {
            ...
            case TYPE_HINFO:
                ...
                break;
            case TYPE_OPT:
                org.trianacode.pegasus.jmdns.impl.constants.DNSResultCode extendedResultCode = org.trianacode.pegasus.jmdns.impl.constants.DNSResultCode.resultCodeForFlags(this.getFlags(), ttl);
                ...
                if (version == 0) {
                    ...
                    while (_messageInputStream.available() > 0) {
                        // Read RDData
                        int optionCodeInt = 0;
                        org.trianacode.pegasus.jmdns.impl.constants.DNSOptionCode optionCode = null;
                        if (_messageInputStream.available() >= 2) {
                            optionCodeInt = _messageInputStream.readUnsignedShort();
                            optionCode = org.trianacode.pegasus.jmdns.impl.constants.DNSOptionCode.resultCodeForFlags(optionCodeInt);
                        } else {
    ...
    public String toString() {
        ...
        if (this.getFlags() != 0) {
            ...
            if ((this.getFlags() & org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.FLAGS_QR_RESPONSE) != 0) {
                buf.append(":r");
            }
            if ((this.getFlags() & org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.FLAGS_AA) != 0) {
                buf.append(":aa");
            }
            if ((this.getFlags() & org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.FLAGS_TC) != 0) {
                buf.append(":tc");
            }
        }
