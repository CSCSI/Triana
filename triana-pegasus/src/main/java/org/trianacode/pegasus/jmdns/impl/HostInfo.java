...
public class HostInfo implements DNSStatefulObject {
    ...
    org.trianacode.pegasus.jmdns.impl.DNSRecord.Address getDNSAddressRecord(DNSRecordType type, boolean unique, int ttl) {
        switch (type) {
            case TYPE_A:
    ...
    private org.trianacode.pegasus.jmdns.impl.DNSRecord.Address getDNS4AddressRecord(boolean unique, int ttl) {
        if ((this.getInetAddress() instanceof Inet4Address) || ((this.getInetAddress() instanceof Inet6Address) && (((Inet6Address) this.getInetAddress()).isIPv4CompatibleAddress()))) {
            return new org.trianacode.pegasus.jmdns.impl.DNSRecord.IPv4Address(this.getName(), DNSRecordClass.CLASS_IN, unique, ttl, this.getInetAddress());
        }
        return null;
    }

    private org.trianacode.pegasus.jmdns.impl.DNSRecord.Address getDNS6AddressRecord(boolean unique, int ttl) {
        if (this.getInetAddress() instanceof Inet6Address) {
            return new org.trianacode.pegasus.jmdns.impl.DNSRecord.IPv6Address(this.getName(), DNSRecordClass.CLASS_IN, unique, ttl, this.getInetAddress());
        }
        return null;
    }

    org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer getDNSReverseAddressRecord(DNSRecordType type, boolean unique, int ttl) {
        switch (type) {
            case TYPE_A:
    ...
    private org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer getDNS4ReverseAddressRecord(boolean unique, int ttl) {
        if (this.getInetAddress() instanceof Inet4Address) {
            return new org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer(this.getInetAddress().getHostAddress() + ".in-addr.arpa.", DNSRecordClass.CLASS_IN, unique, ttl, this.getName());
        }
        if ((this.getInetAddress() instanceof Inet6Address) && (((Inet6Address) this.getInetAddress()).isIPv4CompatibleAddress())) {
            ...
            return new org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer(address + ".in-addr.arpa.", DNSRecordClass.CLASS_IN, unique, ttl, this.getName());
        }
        return null;
    }

    private org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer getDNS6ReverseAddressRecord(boolean unique, int ttl) {
        if (this.getInetAddress() instanceof Inet6Address) {
            return new org.trianacode.pegasus.jmdns.impl.DNSRecord.Pointer(this.getInetAddress().getHostAddress() + ".ip6.arpa.", DNSRecordClass.CLASS_IN, unique, ttl, this.getName());
        }
        return null;
    }
    ...
    public Collection<org.trianacode.pegasus.jmdns.impl.DNSRecord> answers(boolean unique, int ttl) {
        List<org.trianacode.pegasus.jmdns.impl.DNSRecord> list = new ArrayList<org.trianacode.pegasus.jmdns.impl.DNSRecord>();
        org.trianacode.pegasus.jmdns.impl.DNSRecord answer = this.getDNS4AddressRecord(unique, ttl);
        if (answer != null) {
            list.add(answer);
        }
