...
import org.trianacode.pegasus.jmdns.impl.DNSOutgoing.MessageOutputStream;
 ...
 */
public abstract class DNSRecord extends org.trianacode.pegasus.jmdns.impl.DNSEntry {
     ...
     */
    DNSRecord(String name, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType type, DNSRecordClass recordClass, boolean unique, int ttl) {
     ...
     */
    abstract org.trianacode.pegasus.jmdns.impl.DNSOutgoing addAnswer(JmDNSImpl dns, org.trianacode.pegasus.jmdns.impl.DNSIncoming in, InetAddress addr, int port, org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException;

    /**
     * True if this record is suppressed by the answers in a message.
     */
    boolean suppressedBy(org.trianacode.pegasus.jmdns.impl.DNSIncoming msg) {
        try {
    ...
    public static class IPv4Address extends Address {
        ...
        IPv4Address(String name, DNSRecordClass recordClass, boolean unique, int ttl, InetAddress addr) {
            super(name, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType.TYPE_A, recordClass, unique, ttl, addr);
        }
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#getServiceInfo(boolean)
         */
        @Override
    ...
    public static abstract class Address extends DNSRecord {
        ...
        protected Address(String name, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType type, DNSRecordClass recordClass, boolean unique, int ttl, InetAddress addr) {
            super(name, type, recordClass, unique, ttl);
            this._addr = addr;
        }

        protected Address(String name, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordType type, org.trianacode.pegasus.jmdns.impl.constants.DNSRecordClass recordClass, boolean unique, int ttl, byte[] rawAddress) {
            super(name, type, recordClass, unique, ttl);
            try {
        ...
        boolean handleResponse(JmDNSImpl dns) {
            DNSRecord.Address dnsAddress = dns.getLocalHost().getDNSAddressRecord(this.getRecordType(), this.isUnique(), org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.DNS_TTL);
            if (dnsAddress != null) {
                if (dnsAddress.sameType(this) && dnsAddress.sameName(this) && (!dnsAddress.sameValue(this))) {
        ...
        @Override
        org.trianacode.pegasus.jmdns.impl.DNSOutgoing addAnswer(JmDNSImpl dns, org.trianacode.pegasus.jmdns.impl.DNSIncoming in, InetAddress addr, int port, org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException {
            return out;
        }
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#getServiceEvent(org.trianacode.pegasus.jmdns.impl.JmDNSImpl)
         */
        @Override
    ...
    public static class Pointer extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSEntry#isSameEntry(org.trianacode.pegasus.jmdns.impl.DNSEntry)
         */
        @Override
        public boolean isSameEntry(org.trianacode.pegasus.jmdns.impl.DNSEntry entry) {
    ...
    public static class Text extends DNSRecord {
         ...
         */
        @Override
        public org.trianacode.pegasus.jmdns.ServiceEvent getServiceEvent(JmDNSImpl dns) {
            org.trianacode.pegasus.jmdns.ServiceInfo info = this.getServiceInfo(false);
            ((ServiceInfoImpl) info).setDns(dns);
            return new ServiceEventImpl(dns, info.getType(), info.getName(), info);
        }
    ...
    public static class Service extends DNSRecord {
        ...
        void write(MessageOutputStream out) {
            ...
            if (org.trianacode.pegasus.jmdns.impl.DNSIncoming.USE_DOMAIN_NAME_FORMAT_FOR_SRV_TARGET) {
        ...
        org.trianacode.pegasus.jmdns.impl.DNSOutgoing addAnswer(JmDNSImpl dns, org.trianacode.pegasus.jmdns.impl.DNSIncoming in, InetAddress addr, int port, org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException {
            ...
            if (info != null) {
                if (this._port == info.getPort() != _server.equals(dns.getLocalHost().getName())) {
                    return dns.addAnswer(in, addr, port, out, new DNSRecord.Service(info.getQualifiedName(), DNSRecordClass.CLASS_IN, DNSRecordClass.UNIQUE, org.trianacode.pegasus.jmdns.impl.constants.DNSConstants.DNS_TTL, info.getPriority(), info.getWeight(), info.getPort(), dns
    ...
    public static class HostInformation extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#addAnswer(org.trianacode.pegasus.jmdns.impl.JmDNSImpl, org.trianacode.pegasus.jmdns.impl.DNSIncoming, java.net.InetAddress, int, org.trianacode.pegasus.jmdns.impl.DNSOutgoing)
         */
        @Override
        org.trianacode.pegasus.jmdns.impl.DNSOutgoing addAnswer(JmDNSImpl dns, org.trianacode.pegasus.jmdns.impl.DNSIncoming in, InetAddress addr, int port, org.trianacode.pegasus.jmdns.impl.DNSOutgoing out) throws IOException {
            return out;
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#handleQuery(org.trianacode.pegasus.jmdns.impl.JmDNSImpl, long)
         */
        @Override
        boolean handleQuery(JmDNSImpl dns, long expirationTime) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#handleResponse(org.trianacode.pegasus.jmdns.impl.JmDNSImpl)
         */
        @Override
        boolean handleResponse(JmDNSImpl dns) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#sameValue(org.trianacode.pegasus.jmdns.impl.DNSRecord)
         */
        @Override
        boolean sameValue(DNSRecord other) {
        ...
        /*
         * (non-Javadoc)
         * @see org.trianacode.pegasus.jmdns.impl.DNSRecord#write(org.trianacode.pegasus.jmdns.impl.DNSOutgoing)
         */
        @Override
        void write(MessageOutputStream out) {
     ...
     * @return service information
     */
    public abstract org.trianacode.pegasus.jmdns.ServiceInfo getServiceInfo(boolean persistent);
