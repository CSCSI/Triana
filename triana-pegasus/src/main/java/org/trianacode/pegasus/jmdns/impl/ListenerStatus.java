...
public class ListenerStatus<T extends EventListener> {
    ...
    public static class ServiceListenerStatus extends ListenerStatus<ServiceListener> {
        ...
        private final ConcurrentMap<String, org.trianacode.pegasus.jmdns.ServiceInfo> _addedServices;
         ...
         * To get the full resolved information you need to listen to {@link #serviceResolved(ServiceEvent)} or call {@link org.trianacode.pegasus.jmdns.JmDNS#getServiceInfo(String, String, long)}
         *
         * <pre>
         ...
         */
        void serviceAdded(org.trianacode.pegasus.jmdns.ServiceEvent event) {
         ...
         *            The ServiceEvent providing the name and fully qualified type of the service.
         */
        void serviceRemoved(org.trianacode.pegasus.jmdns.ServiceEvent event) {
            String qualifiedName = event.getName() + "." + event.getType();
    ...
    public static class ServiceTypeListenerStatus extends ListenerStatus<ServiceTypeListener> {
         ...
         */
        void serviceTypeAdded(org.trianacode.pegasus.jmdns.ServiceEvent event) {
