...
public class NetworkTopologyDiscoveryImpl implements NetworkTopologyDiscovery {
    ...
    /*
     * (non-Javadoc)
     * @see org.trianacode.pegasus.jmdns.JmmDNS.NetworkTopologyDiscovery#getInetAddresses()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.trianacode.pegasus.jmdns.JmmDNS.NetworkTopologyDiscovery#useInetAddress(java.net.NetworkInterface, java.net.InetAddress)
     */
    @Override
