...
/**
 * This is a cut down version of tool containing the information about a tool that provides
 * a fuller description of a tool for a tool browser.  This information is transferred to
 * fill in whatever it can within the Tool class for fitting in with the existing
 * implementation of Triana.
 *
 * This is a fraction of the size of Tool and encompasses everything one might want to know
 * about a tool before instantiating it.
 *
 * User: Ian Taylor
 * Date: Aug 1, 2010
 * Time: 10:19:47 AM
