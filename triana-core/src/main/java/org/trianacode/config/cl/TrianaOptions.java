...
public class TrianaOptions {
    ...
    public static final Option WORKFLOW_OPTION = new Option("w", "workflow", "workflows", "supply one or more workflows (only a single workflow when used with -n)", true);
    ...
    public static final Option UUID_OPTION = new Option("u", "uuid", "get status of running workflow (in non-gui mode). The -w option in non-gui mode returns a unique id for a workflow");
