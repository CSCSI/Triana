...
//*/
//
//@Tool(panelClass = "org.trianacode.org.trianacode.shiwaall.gui.dax.DaxToPegasusPanel")
...
//                } else {
//                    log("Running org.trianacode.shiwaall.gui-plan locally");
//                    runLocal();
//                }
//            }
//            //           popup.finish();
...
//                    if (responseCode == 200) {
//                        System.out.println("TriPeg reports success queueing workflow on org.trianacode.shiwaall.gui");
//                    } else {
...
////
//        url += "/remotecontrol";
//        log("Trying org.trianacode.shiwaall.gui at " + url);
