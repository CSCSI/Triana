 ...
 */
public class Unbundler152 implements ExecutionAddon {
...
//    private UUID parentUUID = null;
    ...
    public Unbundler152(ShiwaBundleHelper152 shiwaBundleHelper) {
...
//        workflowImplementation = chooseImp();
        ...
        if (workflowImplementation != null) {
            ...
            File file = new File(definitionLocation);
            if(file.exists()){
...
//                    XMLReader reader = new XMLReader(new InputStreamReader(new ByteArrayInputStream(definitionBytes)));
                    XMLReader reader = new XMLReader(new InputStreamReader(new FileInputStream(file)));
...
//                System.exit(1);
    ...
    private void storeShiwaProperty(HashMap<String, String> executionProperties, ShiwaBundleHelper152 shiwaBundleHelper, String key) {
...
//        String[] correctedArgs = null;
        ...
        shiwaBundleHelper = new ShiwaBundleHelper152(pluginArguments.get(1));
