...
//                        }
//                    } catch (Exception e){
//                        image = BundleUtils.getDisplayStream(tg);
//                    }
//                    workflowEngineHandler = new TrianaIWIRHandler152(iwir, image);
//
////                } else if (((ConversionAddon) addon).getServiceName().equals("Triana Dax Template")){
////                    TaskGraph daxified = (TaskGraph) ((ConversionAddon) addon).processWorkflow(tg);
////
////                    final ApplicationFrame frame = GUIEnv.getApplicationFrame();
////                    frame.addParentTaskGraphPanel(daxified);
////                    workflowEngineHandler = new TrianaEngineHandler152(daxified, getDisplayStream(daxified));
//
////                } else if(((ConversionAddon) addon).getServiceName().equals("Pegasus Dax")){
////                    try {
////                        File file = File.createTempFile("dax", ".tmp");
////                        ((ConversionAddon) addon).toolToWorkflowFile(tg, file, null);
////                        System.out.printf("dax : " + file.getAbsolutePath());
////
////                    } catch (Exception e) {
////                        e.printStackTrace();
////                    }
